...
* [Installation](install-and-configure/install/install.md)
  ...
  * [Multi-Cluster](install-and-configure/install/multi-cluster/multi-cluster.md)
    * [ETL Federation (preferred)](install-and-configure/install/multi-cluster/federated-etl/federated-etl.md)
      ...
      * [Migration Guide from Thanos to Kubecost 2.0 (Aggregator)](install-and-configure/install/multi-cluster/federated-etl/aggregator.md)
      * [Backups and Alerting](install-and-configure/install/multi-cluster/federated-etl/thanos-migration-guide.md)
