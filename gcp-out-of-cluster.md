...
GCP users should create a [detailed billing export](https://cloud.google.com/billing/docs/how-to/export-data-bigquery-tables#detailed-usage-cost-data-schema) to gain access to all Kubecost cloud integration features including [reconciliation](cloud-integration.md#reconciliation).
