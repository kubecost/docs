...
The Savings page provides an array of panels containing different insights capable lowering your Kubernetes and cloud spend.
...
To temporarily archive a Savings insights, select the three horizontal dots icon inside its panel, then select _Archive._ You can unarchive an insight by selecting _Unarchive_.
...
On the Savings page, as well as on certain individual Savings insights, you have the ability to designate a cluster profile. Savings recommendations such as right-sizing are calculated in part based on your the current cluster profile:
