...
[Using an existing Prometheus or Grafana installation](getting-started.md#custom-prom)  
[Using an existing node exporter installation](getting-started.md#node-exporter)  
[Exposing Kubecost with an Ingress](getting-started.md#basic-auth)  
[Adding a spot instance configuration \(AWS only\)](getting-started.md#spot-nodes)  
[Allocating out of cluster costs](getting-started.md#out-of-cluster)  
[Refectling Reserved Instance or Committed Use Pricing](getting-started.md#ri-committed-discount)  
...
![AWS Spot info](.gitbook/assets/spot-settings.png)
