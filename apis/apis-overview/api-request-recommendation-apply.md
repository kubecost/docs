...
Examine the cURL example below. The API response can be inspected to see what Kubecost will attempt to do before running the apply step. The plan may do less than the recommendation, see [Current Limitations](/apis/apis-overview/api-request-recommendation-apply.md#current-limitations).
