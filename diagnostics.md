...
![](.gitbook/assets/diagnostics-recording-rules.png)
...
![](.gitbook/assets/diagnostics-etl.png)
...
![](.gitbook/assets/diagnostics-etl-problem.png)

Note the file on `Nov 20, 2020` in the above image appears in **red**. The data in this file has been flagged by our diagnostics page as _empty_ \(failed to pass a minimum size threshold\). This could happen if the database was temporily unavailable while building that day.
...
![](.gitbook/assets/diagnostics-prom-targets.png)
