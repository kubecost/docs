...
{% hint style="warning" %}
If any of the above diagnostic tests fails, view the [How to Troubleshoot Missing Metrics](diagnostics.md#how-to-troubleshoot-missing-metrics) section below.
{% endhint %}
