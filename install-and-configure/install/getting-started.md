...
{% hint style="info" %}
SAML/OIDC configured RBAC is only officially supported on Kubecost Enterprise plans. SSO is available for Free users to configure but is not officially supported.
{% endhint %}
