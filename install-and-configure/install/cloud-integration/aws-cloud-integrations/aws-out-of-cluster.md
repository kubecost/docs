...
More on AWS tagging [here](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Using\_Tags.html).

Tags may take several hours to show up in the _Cost Allocations Tags_ section described in the next step.
