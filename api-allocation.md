...
If `true`, include idle cost (i.e. the cost of the un-allocated assets) as its own allocation. (See [special types of allocation](api-allocation.md).) Default is `true.`
{% endswagger-parameter %}
