...
[No persistent volumes available...](troubleshoot-install.md#persistent-volume)  
[Unable to establish a port-forward connection](troubleshoot-install.md#port-forward)  
[FailedScheduling node-exporter](troubleshoot-install.md#node-exporter)  
[No clusters found](troubleshoot-install.md#no-cluster)  
[Pods running but app won't load](troubleshoot-install.md#app-wont-load)
...
Should you encounter an unexpected error, please reach out for help on [Slack](https://join.slack.com/t/kubecost/shared_invite/enQtNTA2MjQ1NDUyODE5LWFjYzIzNWE4MDkzMmUyZGU4NjkwMzMyMjIyM2E0NGNmYjExZjBiNjk1YzY5ZDI0ZTNhZDg4NjlkMGRkYzFlZTU) or via email at [team@kubecost.com](https://github.com/kubecost/docs/tree/99eb87c477667502efb83fce713d143a017f506b/team@kubecost.com).
...
![No clusters found](.gitbook/assets/no-cluster.png)
...
Many teams deploy helm Tiller with cluster-admin privileges to install and manage applications across different namespaces. More information on managing these permissions at [https://v2.helm.sh/docs/rbac/](https://v2.helm.sh/docs/rbac/)
