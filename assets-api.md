...
{% swagger-parameter in="path" name="filterClusters" %}
...
{% swagger-parameter in="path" name="filterNames" %}
Filter results by asset name.
{% endswagger-parameter %}

{% swagger-parameter in="path" name="filterProjects" %}
...
{% swagger-parameter in="path" name="filterProviderIDs" %}
...
{% swagger-parameter in="path" name="filterTypes" %}
