...
A: Yes, amortized allows upfront costs of the resources to appear in Kubecost. [More info here](../install-and-configure/install/cloud-integration/#cloud-integration-configurations).
