...
{% hint style="danger" %}
These APIs are now deprecated. This page should not be consulted. Please reference the [Allocation API](allocation.md) doc for updated information.
{% endhint %}
...
> NOTE: this API is actively being replaced by the [Kubecost Allocation API](allocation.md). That is the recommended API for querying historical and run-rate cost allocation metrics.
