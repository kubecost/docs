...
### Data Retention
By default metric retention is 91 days, Howerver the retenion of data can be further increased with a configurable value for a property **etlDailyStoreDurationDays**
