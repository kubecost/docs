...
![Prometheus Targets](.gitbook/assets/prom-targets.png)
...
Note that this does not override the source label-- it creates a new label called "pod\_name" and copies the value of the pod into it.
