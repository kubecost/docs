...
* _View Right-Sizing_: Opens the [Request right-sizing recommendations](../../getting-started/savings/auto-request-sizing/auto-request-sizing.md) page in a new tab.
