...
Below are the major components deployed with the [Kubecost helm chart](https://docs.kubecost.com/install), excluding certain Enterprise components such as durable storage:
